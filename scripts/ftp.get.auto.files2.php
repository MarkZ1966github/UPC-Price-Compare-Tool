...
$local_file2 = '/var/www/domains/sportsmanssupplyinc.com/upc/htdocs/upload/images_file.csv';
$server_file2 = '/RapidRetail/ImageFeed/images_file.csv';
...
$upload2 = ftp_get($conn_id, $local_file2, $server_file2, FTP_BINARY); 
